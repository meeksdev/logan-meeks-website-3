...
export default function ThemeSwitch() {
    ...
    if (!mounted) {
        return <label className=" hidden"></label>;
    }
    ...
    if (resolvedTheme) {
        return (
            <Switch onChange={toggleDarkMode} className="group flex items-center gap-1" defaultSelected={defaultSwitchValue} aria-label="Theme Switch">
