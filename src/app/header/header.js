...
function Header() {
    return (
        <header className="sticky top-0 z-50 bg-shakespeare-700 px-6 py-2 text-2xl text-white dark:bg-shakespeare-bg">
            <Link href="/" className="hover:text-shakespeare-500 pressed:text-shakespeare-600" aria-label="Home Page">
                <Logo accentColor="#72d6ee" className="float-left mr-1 inline-block size-8 dark:hidden" />
